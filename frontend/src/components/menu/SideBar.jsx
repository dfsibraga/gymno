        ...
        <ul className="nav flex-column pt-3 pt-md-0">
          <li className="nav-item">
            ...
            >
              ...
              <span className="mt-1 ms-1 sidebar-text">Menu</span>
            </Link>
          </li>
          ...
          <SideBarItem to="/orders" text="Item 1">
            <svg
              className="icon icon-xs me-2"
              fill="currentColor"
              viewBox="0 0 20 20"
          ...
          <SideBarItem to="/automations" text="Item 2">
            <svg
              className="icon icon-xs me-2"
              fill="currentColor"
              viewBox="0 0 20 20"
          ...
          <SideBarItem to="/settings" text="Definições">
            <svg
              className="icon icon-xs me-2"
              fill="currentColor"
              viewBox="0 0 20 20"
